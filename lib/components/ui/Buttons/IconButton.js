...
function (_PureComponent) {
  ...
  _createClass(IconButton, [{
    ...
    value: function componentDidMount() {
      this.mdComponent = new _mdc.MDCRipple(this.mdIconButton);
    ...
    value: function render() {
      ...
      return _react.default.createElement("button", {
        ref: function ref(element) {
          _this.mdIconButton = element;
        },
        className: _classnames.default.apply(void 0, ['material-icons', 'mdc-icon-button'].concat(_toConsumableArray(classes))),
