...
function (_PureComponent) {
  ...
  _createClass(SelectMenu, [{
    ...
    value: function render() {
      ...
      })), !outlined && _react.default.createElement(_react.default.Fragment, null, label && _react.default.createElement(_FloatingLabel.default, null, label), _react.default.createElement(_LineRipple.default, null)), outlined && _react.default.createElement(_SelectMenuNotchedOutlined.default, null, label && _react.default.createElement(_FloatingLabel.default, null, label))), helper && _react.default.createElement(_SelectMenuHelperText.default, null, helper));
    }
  }]);
