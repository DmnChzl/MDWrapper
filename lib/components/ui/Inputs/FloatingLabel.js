...
function (_PureComponent) {
  ...
  function FloatingLabel() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(FloatingLabel).apply(this, arguments));
  }

  _createClass(FloatingLabel, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.mdComponent = new _mdc.MDCFloatingLabel(this.mdFloatingLabel);
    }
  }, {
    key: "render",
