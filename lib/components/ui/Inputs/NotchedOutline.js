...
function (_PureComponent) {
  _inherits(NotchedOutline, _PureComponent);

  function NotchedOutline() {
    _classCallCheck(this, NotchedOutline);

    return _possibleConstructorReturn(this, _getPrototypeOf(NotchedOutline).apply(this, arguments));
  }

  _createClass(NotchedOutline, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.mdComponent = new _mdc.MDCNotchedOutline(this.mdNotchedOutline);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
        ref: function ref(element) {
          _this.mdNotchedOutline = element;
        },
