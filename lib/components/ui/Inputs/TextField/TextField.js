  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_FormField.default, {
        ...
        className: (0, _classnames.default)('mdc-text-field', _defineProperty({}, mdcFullWidth, fullWidth), _defineProperty({}, mdcDisabled, disabled), _defineProperty({}, mdcWithLeadingIcon, icon && !trailing), _defineProperty({}, mdcOutlined, outlined), _defineProperty({}, mdcWithTrailingIcon, icon && trailing))
