...
function (_PureComponent) {
  _inherits(TextFieldHelperText, _PureComponent);

  function TextFieldHelperText() {
    _classCallCheck(this, TextFieldHelperText);

    return _possibleConstructorReturn(this, _getPrototypeOf(TextFieldHelperText).apply(this, arguments));
  }

  _createClass(TextFieldHelperText, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.mdComponent = new _mdc.MDCTextFieldHelperText(this.mdTextFieldHelperText);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement("p", {
        ref: function ref(element) {
          _this.mdTextFieldHelperText = element;
        },
...
var _default = TextFieldHelperText;
