...
function (_PureComponent) {
  _inherits(TextFieldIcon, _PureComponent);

  function TextFieldIcon() {
    _classCallCheck(this, TextFieldIcon);

    return _possibleConstructorReturn(this, _getPrototypeOf(TextFieldIcon).apply(this, arguments));
  }

  _createClass(TextFieldIcon, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.mdComponent = new _mdc.MDCTextFieldIcon(this.mdTextFieldIcon);
    }
  }, {
    key: "render",
...
TextFieldIcon.defaultProps = {
  font: _constants.TEXT_FORMAT
};
TextFieldIcon.propTypes = {
  font: _propTypes.string
};
var _default = TextFieldIcon;
