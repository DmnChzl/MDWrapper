...
function (_Component) {
  ...
  function Demo(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showDialog", function () {
      _this.setState({
        display: true
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "hideDialog", function () {
      _this.setState({
        display: false
      });
    });
