...
function (_Component) {
  ...
  function Demo(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showSnackBar", function () {
      _this.setState({
        display: true
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "hideSnackBar", function () {
      _this.setState({
        display: false
      });
    });
    ...
    value: function render() {
      ...
      return _react.default.createElement(_ui.Grid, null, _react.default.createElement(_ui.GridInner, {
        ...
        onClick: function onClick() {
          return _this2.showSnackBar();
        }
      }, "SnackBar"), _react.default.createElement(_ui.SnackBar, {
        open: display,
        label: 'Close',
        onClick: function onClick() {
          return _this2.hideSnackBar();
        },
        leading: true
      }, "Hello World"))));
    }
