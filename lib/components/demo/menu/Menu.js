...
function (_Component) {
  ...
  function Demo(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "hideMenu", function (label) {
      console.log(label);
  ...
  _createClass(Demo, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_ui.GridCell, null, _react.default.createElement("div", {
        id: "menu-anchor"
      }, _react.default.createElement(_ui.Button, {
        onClick: function onClick() {
          return _this2.showMenu();
        }
      }, "Menu"), _react.default.createElement(_ui.Menu, {
        open: display,
        data: ['First', 'Second', '', 'Third', 'Four'],
        onClick: function onClick(label) {
          return _this2.hideMenu(label);
        }
      })))));
    }
  }]);
